...
ResourcefulLoader plays nicely with "UrlParam":http://github.com/jbr/url-param, which changes the default finder to @:find_by_param@, allowing you to specify the finder on the model.
...
This incurs no lookup cost in the un-nested-route.  ResourcefulLoader will not look in the database if the param is nil, allowing you to provide several alternative.
